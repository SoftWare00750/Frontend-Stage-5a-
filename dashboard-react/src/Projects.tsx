    ...
    >
      ...
      <div style={{ padding: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1.3rem' }}>
          {project.tags.map((tag: string) => (
            <span key={tag} style={{
              ...
              fontFamily: "'JetBrains Mono',monospace", fontSize: '0.7rem', color: 'var(--accent2)',
            }}>
              {tag}
            </span>
          ))}
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          {[{ href: project.demo, label: '↗ Live Demo' }, { href: project.github, label: '⌥ GitHub' }].map(
            ({ href, label }) => (
              <a
                key={label}
                href={href}
                style={{ color: 'var(--text3)', textDecoration: 'none', fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', transition: 'color 0.2s' }}
