...
export const EXPERIENCE: ExperienceItem[] = [
  {
    ...
    desc: 'Leading the Dashboard 2.0 initiative — rebuilding the core merchant analytics surface with SvelteKit and a custom design system serving 4M+ businesses.',
  },
  {
    period: '2021 — 2023',
    company: 'Vercel',
    role: 'Frontend Engineer',
    desc: 'Built real-time deployment pipeline visualisations and the Edge Network monitoring UI. Contributed to the open-source Next.js commerce starter kit.',
  },
  {
    period: '2019 — 2021',
    company: 'Flutterwave',
    role: 'UI Engineer',
    desc: 'Designed and implemented the merchant onboarding flow and transaction explorer. Reduced drop-off by 34% through iterative usability testing.',
  },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    desc: 'Real-time analytics dashboard with live streaming metrics, customisable chart layouts, and WebSocket-powered event feeds.',
    tags: ['SvelteKit', 'Chart.js', 'WebSockets', 'TypeScript'],
    badge: 'Featured',
    emoji: '📊',
    gradient: 'linear-gradient(135deg,#0d1220 0%,#1a2540 100%)',
    demo: '#',
    github: '#',
    category: 'svelte',
  },
  {
    id: 'p2',
    title: 'Orion 3D Portfolio',
    desc: 'Immersive WebGL portfolio with procedural particle systems, post-processing effects, and physics-based camera controls.',
    tags: ['Three.js', 'GSAP', 'GLSL', 'Vite'],
    badge: '3D',
    emoji: '🌌',
    gradient: 'linear-gradient(135deg,#0a0012 0%,#1a003a 100%)',
    demo: '#',
    github: '#',
    category: '3d',
  },
  {
    ...
    desc: 'Full-stack e-commerce platform with edge-rendered product pages, Stripe Checkout, and a headless CMS integration.',
    tags: ['Next.js', 'Stripe', 'Sanity', 'Prisma'],
    badge: 'Full Stack',
    emoji: '🛍️',
  ...
  {
    id: 'p4',
    title: 'Svelte Motion Lab',
    desc: 'Open-source animation library for Svelte — spring physics, keyframe sequencing, and scroll-driven transitions.',
    tags: ['Svelte', 'TypeScript', 'Rollup', 'OSS'],
    badge: 'OSS',
    emoji: '🎞️',
