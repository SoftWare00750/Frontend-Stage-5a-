    ...
    <section id="contact" style={{ padding: '7rem 3rem', background: 'var(--bg2)' }}>
      ...
      <h2
        ...
        style={{
          ...
          textAlign: 'center', lineHeight: 1.1, marginBottom: '1rem',
        }}
      >
      ...
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        <p className="reveal" style={{
          ...
          just want to chat about frontend engineering — my inbox is always open.
        </p>
        ...
        >
          ...
          {(
            ...
            <div key={field.id} style={{ marginBottom: '1.5rem' }}>
              <label style={{
                ...
                fontSize: '0.72rem', color: 'var(--accent2)', letterSpacing: '0.15em',
          ...
          {/* Error */}
          {error && (
            <p style={{ color: '#f87171', fontSize: '0.82rem', marginBottom: '1rem', fontFamily: "'JetBrains Mono',monospace" }}>
              {error}
            </p>
          )}
          ...
          <button
            ...
            style={{
              ...
              padding: '1rem', borderRadius: '6px', fontFamily: "'Syne',sans-serif",
          ...
          {submitted && (
            <div style={{
              ...
              borderRadius: '6px', color: '#4ade80', fontSize: '0.85rem', textAlign: 'center',
            }}>
